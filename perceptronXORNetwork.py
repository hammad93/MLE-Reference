...
class Perceptron:
    ...
    def activate(self, values):
        ...
        """
        '''
        The below code was edited from the original because of the following error:
        ValueError: shapes (2,) and (3,) not aligned: 2 (dim 0) != 3 (dim 0)
        An alternative original solution is below
        '''
...
def EvalNetwork(inputValues, Network):
    ...
    '''
    References: 
    XOR as Perceptron Network Video (Udacity) from the Neural Networks set
    '''
